...
namespace MyJetWallet.Circle.Models.WireTransfers
{
    ...
    {
        [JsonProperty("name", NullValueHandling = NullValueHandling.Ignore), DataMember(Order = 1)]
        ...
        [JsonProperty("postalCode", NullValueHandling = NullValueHandling.Ignore), DataMember(Order = 7)]
